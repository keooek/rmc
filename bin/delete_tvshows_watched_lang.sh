...
sqlite3 ~/.kodi/userdata/Database/MyVideos116.db "select episode.c18 from episode, files where episode.idFile = files.idFile and files.playcount not null order by episode.c18;" > $rmc_base/tmp/tvshows_delete.tmp
